...
Slim::get('/testimonies', function () {

  // Slim::view()->setData(array("baseURL" => $baseurl,"username"=> $username));
  Slim::render('testimonies.html');
});

Slim::get('/welcome', function () {

  // Slim::view()->setData(array("baseURL" => $baseurl,"username"=> $username));
  Slim::render('homepage.html');
});

Slim::get('/about-us', function () {

  // Slim::view()->setData(array("baseURL" => $baseurl,"username"=> $username));
  Slim::render('about-us.html');
});
